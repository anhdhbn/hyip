...
@celery.task(name='celeryapp.tasks.check_scam_all', queue='default')
def check_scam_all():
...
@celery.task(name='celeryapp.tasks.check_scam', max_retries=3, exponential_backoff=2, retry_jitter=False, autoretry_for=(Exception,), queue='default')
